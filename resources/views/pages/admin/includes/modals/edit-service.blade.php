    ...
    @endphp
    <!-- The Modal -->
    <div class="modal fade custom-modal" id="edit-service">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">

                    <!-- Modal Header -->
                    <div class="modal-header text-center">
                        <h4 class="modal-title text-center w-100">Edit Service</h4>
                    </div>
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description"
                                                  class="form-control"
                                                  placeholder="Describe your AI service">{{ $service->description }}</textarea>
                                    </div>
