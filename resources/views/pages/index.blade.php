            ...
            <div class="row align-items-center">
                <div class="col-md-8 col-lg-7">
                    <div class="banner-content aos mt-5 pt-5" data-aos="fade-up">
                        ...
                        <h1>
                            Join the global network of freelance<br /> AI talents to develop AI applications <br />for
                            businesses
                        </h1>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="great-blk aos boxes-shadow" data-aos="fade-up">
                        ...
                        <div class="great-content">
                            <h4>Flexible work</h4>
                            <p>Multiple flexible engagements: full-time contract, part-time, hourly, project based. Work
                                anywhere remotely</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
                    <div class="great-blk aos boxes-shadow" data-aos="fade-up">
                        ...
                        <div class="great-content">
                            ...
                            <p>Based on your experience and skills in AI, you will be matched to suitable projects and
                                clients by our expert. No searching and bidding</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
