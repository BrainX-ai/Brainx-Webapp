                ...
                <div class="  card m-2 border-0  col-md-12 ">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row mt-4">
                            ...
                            @if ($job->job_type != 'Fixed price')
                                <div class="col-md-6 pb-3">
                                    <strong>Duration: </strong> <span class="h6">{{ $job->duration_in_weeks }}
                                        weeks</span>
                                </div>
                                <div class="col-md-6 pb-3">
                                    <strong>Hours per week: </strong> <span
                                        class="h6">{{ $job->hours_per_week }}</span>
                                </div>
                                <div class="col-md-12 pb-3">
