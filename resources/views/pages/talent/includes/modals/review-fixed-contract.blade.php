<style>
    ...
    .progress {
        ...
        height: 4px;
        width: 0%;
        /* need to be dynamic based on deposit status */
        z-index: -1;
...
<!-- The Modal -->
<div class="modal fade custom-modal" id="review-fixed-contract">
                ...
                <div class="  card m-2 border-0  col-md-12 ">
                    <div class="card-body ">
                        ...
                        <div class="form-group">
                            ...
                            <p id="contract_name_fixed">
                                {{ $job->job_title }}
                            </p>
                        </div>
                        <div class="form-group">
                            <h5 for="">Description</h5>
                            <p id="description_fixed">
                        ...
                        <div class="mt-4">
                            <h5>Fixed price $ <span id="fixed_price_in_review"></span></h5>
                        </div>

                        <div id="fixed_contract">
                    ...
                    <div class="card-footer pb-2 border-0 text-end">
                        <button type="button" class="btn btn-outline-primary ps-4 pe-4 me-3" data-bs-toggle="modal"
                            data-bs-target="#create-contract">Back</button>
